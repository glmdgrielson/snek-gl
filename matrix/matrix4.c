...
matrix4* matrix_mul(matrix4 *a, matrix4 *b, matrix4 *out) {
    ...
    out->v[2][0] = a00 * b20 + a10 * b21 + a20 * b22 + a30 * b33;
    out->v[2][1] = a01 * b20 + a11 * b21 + a21 * b22 + a31 * b33;
    out->v[2][2] = a02 * b20 + a12 * b21 + a22 * b22 + a32 * b33;
    out->v[2][3] = a03 * b20 + a13 * b21 + a23 * b22 + a33 * b33;
